...
SSRN 于 1994 年由两位金融经济学家迈克尔·詹森和韦恩·马尔创立。他们有许多专门的研究网络，根据 PDF 文件、反向链接和谷歌学术结果的数量，2013 年 1 月，SSRN 通过知识库网站排名被评为世界上最大的开放存取知识库(由[网络计量学实验室](https://en.wikipedia.org/wiki/Cybermetrics_Lab)发起)。
